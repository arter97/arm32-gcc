...
enum opt_code
{
  ...
  OPT_mapcs = 1272,                          /* -mapcs */
  OPT_mapcs_frame = 1273,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1274,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1275,              /* -mapcs-stack-check */
  OPT_march_ = 1276,                         /* -march= */
  OPT_marm = 1277,                           /* -marm */
  OPT_masm_syntax_unified = 1278,            /* -masm-syntax-unified */
  OPT_mbe32 = 1279,                          /* -mbe32 */
  OPT_mbe8 = 1280,                           /* -mbe8 */
  OPT_mbig_endian = 1281,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1282,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1283,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1284,     /* -mcaller-super-interworking */
  OPT_mcmse = 1285,                          /* -mcmse */
  OPT_mcpu_ = 1286,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1287,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1288,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1289,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1290,                  /* -mfp16-format= */
  OPT_mfpu_ = 1291,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1292,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 1293, */              /* -mhard-float */
  OPT_mlittle_endian = 1294,                 /* -mlittle-endian */
  OPT_mlong_calls = 1295,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1296,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1297,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1298,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1299,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1300,               /* -mprint-tune-info */
  OPT_mpure_code = 1301,                     /* -mpure-code */
  OPT_mrestrict_it = 1302,                   /* -mrestrict-it */
  OPT_msched_prolog = 1303,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1304,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1305,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1306, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1307,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1308,                         /* -mthumb */
  OPT_mthumb_interwork = 1309,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1310,                  /* -mtls-dialect= */
  OPT_mtp_ = 1311,                           /* -mtp= */
  OPT_mtpcs_frame = 1312,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1313,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1314,                         /* -mtune= */
  OPT_munaligned_access = 1315,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1316,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1317,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1318,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1319,              /* -mword-relocations */
  OPT_n = 1320,                              /* -n */
  ...
  OPT_nolibc = 1326,                         /* -nolibc */
  OPT_nophoboslib = 1327,                    /* -nophoboslib */
  OPT_nostartfiles = 1328,                   /* -nostartfiles */
  OPT_nostdinc = 1329,                       /* -nostdinc */
  OPT_nostdinc__ = 1330,                     /* -nostdinc++ */
  OPT_nostdlib = 1331,                       /* -nostdlib */
  OPT_o = 1332,                              /* -o */
  OPT_p = 1333,                              /* -p */
  ...
  OPT_shared_libphobos = 1359,               /* -shared-libphobos */
  /* OPT_specs = 1360, */                    /* -specs */
  OPT_specs_ = 1361,                         /* -specs= */
  OPT_static = 1362,                         /* -static */
  OPT_static_libasan = 1363,                 /* -static-libasan */
  OPT_static_libgcc = 1364,                  /* -static-libgcc */
  ...
  OPT_static_libphobos = 1370,               /* -static-libphobos */
  OPT_static_libstdc__ = 1371,               /* -static-libstdc++ */
  OPT_static_libtsan = 1372,                 /* -static-libtsan */
  OPT_static_libubsan = 1373,                /* -static-libubsan */
  OPT_static_pie = 1374,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1382,                      /* -std=c++2a */
  OPT_std_c__98 = 1383,                      /* -std=c++98 */
  OPT_std_c11 = 1384,                        /* -std=c11 */
  OPT_std_c17 = 1385,                        /* -std=c17 */
  /* OPT_std_c18 = 1386, */                  /* -std=c18 */
  /* OPT_std_c1x = 1387, */                  /* -std=c1x */
  OPT_std_c2x = 1388,                        /* -std=c2x */
  /* OPT_std_c89 = 1389, */                  /* -std=c89 */
  OPT_std_c90 = 1390,                        /* -std=c90 */
  OPT_std_c99 = 1391,                        /* -std=c99 */
  /* OPT_std_c9x = 1392, */                  /* -std=c9x */
  OPT_std_f2003 = 1393,                      /* -std=f2003 */
  OPT_std_f2008 = 1394,                      /* -std=f2008 */
  OPT_std_f2008ts = 1395,                    /* -std=f2008ts */
  OPT_std_f2018 = 1396,                      /* -std=f2018 */
  ...
  OPT_std_gnu__2a = 1406,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1407,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1408,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1409,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1410, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1411, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1412,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1413, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1414,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1415,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1416, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1417, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1418,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1419, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1420, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1421, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1422, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1423, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1424,                     /* -std=legacy */
  ...
  OPT_trigraphs = 1431,                      /* -trigraphs */
  OPT_u = 1432,                              /* -u */
  OPT_undef = 1433,                          /* -undef */
  OPT_v = 1434,                              /* -v */
  OPT_version = 1435,                        /* -version */
  OPT_w = 1436,                              /* -w */
  OPT_wrapper = 1437,                        /* -wrapper */
  OPT_x = 1438,                              /* -x */
  OPT_z = 1439,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
