...
enum opt_code
{
  ...
  OPT_mapcs = 1597,                          /* -mapcs */
  OPT_mapcs_frame = 1598,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1599,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1600,              /* -mapcs-stack-check */
  OPT_march_ = 1601,                         /* -march= */
  OPT_marm = 1602,                           /* -marm */
  OPT_masm_syntax_unified = 1603,            /* -masm-syntax-unified */
  OPT_mbe32 = 1604,                          /* -mbe32 */
  OPT_mbe8 = 1605,                           /* -mbe8 */
  OPT_mbig_endian = 1606,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1607,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1608,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1609,     /* -mcaller-super-interworking */
  OPT_mcmse = 1610,                          /* -mcmse */
  OPT_mcpu_ = 1611,                          /* -mcpu= */
  OPT_mfdpic = 1612,                         /* -mfdpic */
  OPT_mfix_cortex_m3_ldrd = 1613,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1614,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1615,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1616,                  /* -mfp16-format= */
  OPT_mfpu_ = 1617,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1618,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 1619, */              /* -mhard-float */
  OPT_mlittle_endian = 1620,                 /* -mlittle-endian */
  OPT_mlong_calls = 1621,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1622,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1623,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1624,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1625,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1626,               /* -mprint-tune-info */
  OPT_mpure_code = 1627,                     /* -mpure-code */
  OPT_mrestrict_it = 1628,                   /* -mrestrict-it */
  OPT_msched_prolog = 1629,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1630,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1631,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1632, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1633,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1634,                         /* -mthumb */
  OPT_mthumb_interwork = 1635,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1636,                  /* -mtls-dialect= */
  OPT_mtp_ = 1637,                           /* -mtp= */
  OPT_mtpcs_frame = 1638,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1639,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1640,                         /* -mtune= */
  OPT_munaligned_access = 1641,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1642,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1643,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1644,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1645,              /* -mword-relocations */
  OPT_n = 1646,                              /* -n */
  OPT_name_sort = 1647,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1648,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1649,              /* -no-integrated-cpp */
  OPT_no_pie = 1650,                         /* -no-pie */
  OPT_nocpp = 1651,                          /* -nocpp */
  OPT_nodefaultlibs = 1652,                  /* -nodefaultlibs */
  OPT_nolibc = 1653,                         /* -nolibc */
  OPT_nophoboslib = 1654,                    /* -nophoboslib */
  OPT_nostartfiles = 1655,                   /* -nostartfiles */
  OPT_nostdinc = 1656,                       /* -nostdinc */
  OPT_nostdinc__ = 1657,                     /* -nostdinc++ */
  OPT_nostdlib = 1658,                       /* -nostdlib */
  OPT_o = 1659,                              /* -o */
  OPT_objects = 1660,                        /* -objects */
  OPT_p = 1661,                              /* -p */
  OPT_pass_exit_codes = 1662,                /* -pass-exit-codes */
  /* OPT_pedantic = 1663, */                 /* -pedantic */
  OPT_pedantic_errors = 1664,                /* -pedantic-errors */
  OPT_pg = 1665,                             /* -pg */
  OPT_pie = 1666,                            /* -pie */
  OPT_pipe = 1667,                           /* -pipe */
  OPT_print_file_name_ = 1668,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1669,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1670,          /* -print-multi-directory */
  OPT_print_multi_lib = 1671,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1672,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1673,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1674,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1675,               /* -print-prog-name= */
  OPT_print_search_dirs = 1676,              /* -print-search-dirs */
  OPT_print_sysroot = 1677,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1678,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1679,                    /* -print-value */
  OPT_quiet = 1680,                          /* -quiet */
  OPT_r = 1681,                              /* -r */
  OPT_remap = 1682,                          /* -remap */
  OPT_reverse_sort = 1683,                   /* -reverse-sort */
  OPT_s = 1684,                              /* -s */
  OPT_save_temps = 1685,                     /* -save-temps */
  OPT_save_temps_ = 1686,                    /* -save-temps= */
  OPT_shared = 1687,                         /* -shared */
  OPT_shared_libgcc = 1688,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1689,               /* -shared-libphobos */
  OPT_size_sort = 1690,                      /* -size-sort */
  /* OPT_specs = 1691, */                    /* -specs */
  OPT_specs_ = 1692,                         /* -specs= */
  OPT_static = 1693,                         /* -static */
  OPT_static_libasan = 1694,                 /* -static-libasan */
  OPT_static_libgcc = 1695,                  /* -static-libgcc */
  OPT_static_libgfortran = 1696,             /* -static-libgfortran */
  OPT_static_libgo = 1697,                   /* -static-libgo */
  OPT_static_liblsan = 1698,                 /* -static-liblsan */
  OPT_static_libmpx = 1699,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1700,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1701,               /* -static-libphobos */
  OPT_static_libstdc__ = 1702,               /* -static-libstdc++ */
  OPT_static_libtsan = 1703,                 /* -static-libtsan */
  OPT_static_libubsan = 1704,                /* -static-libubsan */
  OPT_static_pie = 1705,                     /* -static-pie */
  /* OPT_std_c__03 = 1706, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1707, */                /* -std=c++0x */
  OPT_std_c__11 = 1708,                      /* -std=c++11 */
  OPT_std_c__14 = 1709,                      /* -std=c++14 */
  OPT_std_c__17 = 1710,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1711, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1712, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1713, */                /* -std=c++20 */
  OPT_std_c__2a = 1714,                      /* -std=c++2a */
  OPT_std_c__98 = 1715,                      /* -std=c++98 */
  OPT_std_c11 = 1716,                        /* -std=c11 */
  OPT_std_c17 = 1717,                        /* -std=c17 */
  /* OPT_std_c18 = 1718, */                  /* -std=c18 */
  /* OPT_std_c1x = 1719, */                  /* -std=c1x */
  OPT_std_c2x = 1720,                        /* -std=c2x */
  /* OPT_std_c89 = 1721, */                  /* -std=c89 */
  OPT_std_c90 = 1722,                        /* -std=c90 */
  OPT_std_c99 = 1723,                        /* -std=c99 */
  /* OPT_std_c9x = 1724, */                  /* -std=c9x */
  OPT_std_f2003 = 1725,                      /* -std=f2003 */
  OPT_std_f2008 = 1726,                      /* -std=f2008 */
  OPT_std_f2008ts = 1727,                    /* -std=f2008ts */
  OPT_std_f2018 = 1728,                      /* -std=f2018 */
  OPT_std_f95 = 1729,                        /* -std=f95 */
  OPT_std_gnu = 1730,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1731, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1732, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1733,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1734,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1735,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1736, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1737, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1738, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1739,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1740,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1741,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1742,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1743, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1744, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1745,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1746, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1747,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1748,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1749, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1750, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1751,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1752, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1753, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1754, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1755, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1756, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1757,                     /* -std=legacy */
  OPT_symbol_ = 1758,                        /* -symbol= */
  OPT_symbolic = 1759,                       /* -symbolic */
  OPT_t = 1760,                              /* -t */
  OPT_time = 1761,                           /* -time */
  OPT_time_ = 1762,                          /* -time= */
  OPT_traditional = 1763,                    /* -traditional */
  OPT_traditional_cpp = 1764,                /* -traditional-cpp */
  OPT_tree_stats = 1765,                     /* -tree-stats */
  OPT_trigraphs = 1766,                      /* -trigraphs */
  OPT_type_stats = 1767,                     /* -type-stats */
  OPT_u = 1768,                              /* -u */
  OPT_undef = 1769,                          /* -undef */
  OPT_v = 1770,                              /* -v */
  OPT_version = 1771,                        /* -version */
  OPT_w = 1772,                              /* -w */
  OPT_wrapper = 1773,                        /* -wrapper */
  OPT_x = 1774,                              /* -x */
  OPT_z = 1775,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
